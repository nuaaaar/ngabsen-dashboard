        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <p class="card-title font-weight-bold">Tambah {{ $role }}</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="d-md-flex">
                                                <div class="rounded preview-thumbnail-wrapper">
                                                    <img src="/app-assets/images/logo/logo-ngabsen.png" style="width: 100px" class="img-fluid" id="edit-thumbnail-preview">
                                                </div>
